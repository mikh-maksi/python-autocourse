...
## Формат курса
У вас появилась среда запуска, в которой вы сможете запускать файлы. Но работа программиста - это лишь только на небольшую часть умение запускать файлы на рабочем месте. А на большую часть - это умение программировать.  
Умение программировать нарабатывается от решения большого количества задач. Но также начинающему программисту очень важно, чтобы его работу кто-то проверял и указывал ему на возможные неточности и ошибки.  
В GoITeens разработан специальный тренажер, который позволяет отработать навыки программирования.  
Каждый день вы будете получать задания на наработку определенных навыков и после выполнения этих заданий вы получите в качестве бонуса текст программы на Python в которой реализован определенный функционал телеграмм-бота.  Т.е. вы каждый день будете развивать своего телеграмм-бота добавляя ему новый и новый функционал.
